...
-information, demonstrating skills in API design, server-side development, and database interactions.`,
  },
  {
    ...
    title: 'etch-a-sketch',
    text: `-Developed a digital Etch-a-Sketch application using HTML, CSS, and JavaScript. \n
-Implemented a grid-based canvas allowing users to draw, simulating the classic toy experience. \n
-Utilized dynamic DOM manipulation for canvas updates and handled user events for drawing. \n` ,
  },
];
